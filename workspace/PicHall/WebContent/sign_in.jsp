...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/sign_in.css" />
<noscript>
	<link rel="stylesheet"
		...
		<div id="main">
			...
			<section class="post">
				...
				<div class="row gtr-uniform">
					<div class="col-6" id="sign_up_wrap">
						<br> <label>이름</label>
						<div>
						...
						<br> <label>비밀번호</label>
						<div>
							<input type="password" name="member_pw" id="member_pw" value=""
								placeholder="8~32자리" /> <input type="password"
								name="member_pw_re" id="member_pw_re" value=""
								placeholder="비밀번호 재입력" style="margin-top: 0.5em" />
						</div>
						<br> <label>닉네임</label>
						<div>
							<div>
						...
						<div>
							<input type="email" name="member_email" id="member_email"
								placeholder="email@pichall.com" />
						</div>
						<br><p id="emailCheck_text"></p>
					</div>

					<div class="col-6" id="img_wrap">
						<br>
						<div style="padding-right: 0px">
							<span class="image fit"><img src="${pageContext.request.contextPath}/images/pic03.jpg" alt="" /></span>
						</div>
					</div>
				</div>
				<div class="row gtr-uniform" id="sign_btn_wrap" style="margin-top: 1em">

					<div class="col-12">
						<!-- 버튼 타입은 form 안에서 submit을 기본으로 가지기 때문에 input[type=button]으로 변경 -->
						<input type="button" class="btn" value="회원가입 이용약관">
...
제1조 (목적)
본 약관은 WEB7 주식회사(이하 '회사')가 고도 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.
...
본 약관은 2020년 11월 16일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
					...
					<div class="col-12 checkbox">
						...
						<label for="agree" style="font-family: inherit">위 약관에 동의합니다</label>
					</div>

					<div class="col-12">
						<a href="javascript:formSubmit()" class="button primary"
							id="sign_up_btn">회원가입</a>
					</div>
				</div>
