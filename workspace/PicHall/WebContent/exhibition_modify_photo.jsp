...
<body class="is-preload">
	...
	<c:set var="photoSeqList" value="${requestScope.photoSeqList}" />
	<!-- Wrapper -->
	<div id="wrapper">
		<!-- Main -->
		...
		<div id="main">
			...
			<div class="col-12" style="width: 100%;">
				<form name="photoForm" method="post"
					action="${pageContext.request.contextPath}/exhibition/ExhibitionPhotoModifyOk.ex">
					<input type="hidden" name="exhibitionJson"
						value="${requestScope.exhibitionJson}" /> <input type="hidden"
						name="exhibition_seq" value="${requestScope.exhibition_seq}" /> <input
						type="hidden" name="main_photo_data"
						value="${requestScope.main_photo_data}" />
					<table>
						<tr>
							<td>
