...
<body class="is-preload">
	...
	<form name="uploadForm"	action="${pageContext.request.contextPath}/exhibition/ExhibitionSettingOk.ex" method="post">
		<input type="hidden" name="member_seq" value="${requestScope.member_seq}"/>
		<!-- Main -->
		<div id="main">
					...
					<div class="col-12" id="exhibition_detail_wrap">
						...
						<div>
							<textarea name="exhibition_text" id="exhibition_text" style="resize: none;"
								placeholder="전시회 설명을 입력해주세요"></textarea>
						</div>
					...
					<div class="col-6" id="date_wrap">
						<table>
							...
							<tr>
		    					...
		    					<td>
								      <p><input type="date" id="end_date" name="end_date" value="2021-12-31" min="currentDate" max="2099-12-31"></p>
